    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('category', models.CharField(choices=[('Shopping', 'Shopping'), ('Groceries', 'Groceries'), ('Restaurants', 'Restaurants'), ('Transport', 'Transport'), ('Cash', 'Cash'), ('Travel', 'Travel'), ('Health', 'Health'), ('Transfers', 'Transfers'), ('Other', 'Other')], default='Other', max_length=20)),
